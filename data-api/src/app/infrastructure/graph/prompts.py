"""
Query-only prompts for GraphRAG — ported from lightrag/prompt.py.
Only the prompts needed for the query path (no ingestion prompts).
"""
...
Document Chunks (may be truncated due to length):
