...
from app.application.services.agent_service import AgentService, get_agent_service
...
async def create_agent(
    ...
    return create_success_response(data=agent.to_dict(), request_id=request_id)
